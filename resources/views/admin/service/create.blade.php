            ...
            <div class="card">
                ...
                <form action="{{ action('ServicesController@store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="subcategory_id" id="exampleFormControlSelect1">
                                    <option  disabled selected> Select Course Sub Category</option>
                        ...
                        <div class="form-group">
                            ...
                            {{-- <textarea name="objectives" rows=10 class="form-control" placeholder="Course Objectives" > </textarea><br> --}}
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                           ...
                           <small>Note: This Information will be displayed after the customers choose the service.</small>
                            {{-- <textarea name="organizers" rows=10 class="form-control" placeholder="Course Objectives" > </textarea><br> --}}
                        </div>
                        <br>
