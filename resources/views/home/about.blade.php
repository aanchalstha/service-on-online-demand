...
<p class="intro-desc">
    Service On Online Demand offers variety of services which is very useful to our audiences. It is very easy to use and the quality of service provided is very much better. We prioritize customer satisfaction as our main principle.
</p>
<a href="{{url('services')}}" class="btn btn-common btn-lg">View Services</a>
</div>
</div>
<div class="col-md-6 col-lg-6 col-xs-12">
